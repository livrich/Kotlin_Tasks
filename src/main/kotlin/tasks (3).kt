...
class PharmaceuticalStockTracker{
    val inStockMedications = listOf<MedicationContainer>()
}

open class MedicationContainer(anID:String, aName:String, anExpirationDate:Date, isExpired:Boolean){
    val id:String = anID
    val name:String = aName
    val expirationDate:Date = anExpirationDate
    var expired:Boolean =isExpired
        set(value) {
...
class LiquidMedicationContainer(anID:String, aName:String, anExpirationDate:Date, aVolume:Double, aConcentration:Int, aConcentrationUnit:String) :
            MedicationContainer(anID,aName,anExpirationDate) {
    val volume:Double = aVolume
    val concentration:Int = aConcentration
    val unit:String = aConcentrationUnit
}

class TabletMedicationContainer(anID:String, aName:String, anExpirationDate:Date, aPillCount:Int, aPotency:Double, aPotencyUnit:String) :
            MedicationContainer(anID,aName,anExpirationDate) {
    val pillCount:Int = aPillCount
    val potency:Double = aPotency
    val unit:String = aPotencyUnit
}
